...
if ($sql = mysqli_query($koneksi, $query)) {
    ...
    $sesi_email    = $users['email'] ?? '';
    $sesi_username = $users['username'] ?? '';
    $sesi_role     = $users['role'] ?? '';
}

// Pastikan pengguna sudah login dan memiliki role klien
if (!isset($sesi_role) || $sesi_role !== 'klien') {
...
<body>
    ...
    <div id="app">
        <div id="main" class="layout-horizontal">
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            ...
                            <li class="menu-item">
                                <a href="klien" class="menu-link">
                                    <i class="bi bi-grid-fill"></i> Dashboard
                                </a>
                            </li>

                            <li class="menu-item">
                                <a href="?page=list mua" class="menu-link">
                                    <i class="bi bi-stars"></i> List MUA
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="?page=riwayat booking mua" class="menu-link">
                                    <i class="bi bi-calendar-check-fill"></i> Riwayat Booking
                                </a>
                            </li>
                            <li class="menu-item">
            ...
            <!-- Modal Logout -->
            <div class="modal fade text-left" id="modal-logout" tabindex="-1" aria-labelledby="modalLogoutLabel" data-bs-backdrop="false" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Anda akan keluar dari dashboard klien.</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">Batal</button>
                            <a href="../auth/logout" class="btn btn-danger ms-1">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-wrapper container">
                ...
                switch ($page) {
                    case 'profile':
                        include 'pages/profile_klien.php';
                        break;
                    case 'list mua':
                        include 'pages/list_mua_klien.php';
                        break;
                    case 'riwayat booking mua':
                        include 'pages/riwayat_booking_klien.php';
                        break;
                    case 'galeri mua':
                    ...
                    case 'booking mua':
                        ...
                        break;
                    default:
                        include 'pages/dashboard_klien.php';
                        break;
                }
                ?>
            </div>
